...
Version {version}";
    ...
    private static bool GetStartsWithWindows()
    {
        try
        {
    ...
    private static void SetStartsWithWindows(bool enable)
    {
        try
        {
    ...
    {
        var newValue = !GetStartsWithWindows();
        SetStartsWithWindows(newValue);
